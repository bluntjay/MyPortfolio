...
class MyInfo extends React.Component{
  render(){
    ...
    {/*Writes infomation from the object into HTML*/}
      ...
      <u className="refText">E-mail:</u><p className="myInfo"><a target="_blank" href="mailto:ialexjoshua@gmail.com">ialexjoshua@gmail.com</a></p>
      <u className="refText">GitHub:</u><p className="myInfo"><a target="_blank" href="https://github.com/bluntjay">@bluntjay</a></p>
      <u className="refText">LinkedIn:</u><p className="myInfo"><a target="_blank" href="https://www.linkedin.com/in/alex-joshua-80817018b/">Alex Joshua</a></p>
      </div>
