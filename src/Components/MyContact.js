...
export default class MyContact extends React.Component{
	render(){
		return(
			<div id="footerStyle"  className="container-fluid">
			<footer id="contact">
